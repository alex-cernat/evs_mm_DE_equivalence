...
ipfweight wei_sex wei_age wei_educ wei_hh wei_cit wei_rel ///
	if survey_mode == 1 & break_off == 0, gen(wei_f2f) val( ///
	49.1 50.9 ///
...
ipfweight wei_sex wei_age wei_educ wei_hh wei_cit wei_rel ///
	if survey_mode == 2 & break_off == 0, gen(wei_mms) val( ///
	49.1 50.9 ///
	16.8 15.1 15.5 19.3 14.6 18.8 ///
	18.7 57.0 24.3 ///
	20.9 33.5 18.0 18.5 9.0 ///
	...
	28.6 26.6 44.9) maxit(50) tol(.05) 
ipfweight wei_sex wei_age wei_educ wei_hh wei_cit wei_rel ///
	if survey_mode == 3 & break_off == 0, gen(wei_mmf) val( ///
	49.1 50.9 ///
	16.8 15.1 15.5 19.3 14.6 18.8 ///
	18.7 57.0 24.3 ///
	20.9 33.5 18.0 18.5 9.0 ///
...
save "data/ger_evs_data.dta", replace
